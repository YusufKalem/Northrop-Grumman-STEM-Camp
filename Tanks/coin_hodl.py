...
class Coin(arcade.Sprite):
    ...
    def reset_pos(self):
        #this moves the coin to a random spot on the screen
    ...
    def update(self):
        ...
        #check if coin is passed the bottom
        if self.top < 0:
            self.reset_pos()
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.coin_sprite_list.append(self.player_sprite)
    ...
    def on_draw(self):
        ...
        arcade.draw_text(output, 10, 20, arcade.color.AMBER, 14)
